...
#include "dialog_hru.h"
#include "notebook_hru.h"
...
dialog_hru::dialog_hru
	(wxWindow *pParent,
	HRU_record *hru,
	SubBasin *basin,
	SWATControlRecord *control,
	swat_controller *controller)
	: wxDialog (pParent, -1, "HRU") // , wxDefaultPosition, wxSize (400, 600))
{
 	wxBoxSizer *stack = new wxBoxSizer( wxVERTICAL );

	wxPanel *panel = new wxPanel(this, wxID_ANY);

    notebook = new notebook_hru (panel, hru, basin, control, controller, wxSize (600, 550));
...
BEGIN_EVENT_TABLE(dialog_hru, wxDialog)
END_EVENT_TABLE()

void dialog_hru::EndModal
	(int retCode)
